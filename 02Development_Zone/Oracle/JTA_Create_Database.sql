...
-- |v003    |Admin  |2026-09-08|Use seq prefix without _seq suffix
----------------------------------------------------------------------
--v003s
...
CREATE SEQUENCE seq_error START WITH 1 INCREMENT BY 1 CACHE 10;
...
CREATE SEQUENCE seq_event START WITH 1 INCREMENT BY 1 CACHE 10;
...
CREATE SEQUENCE seq_product_id START WITH 1 INCREMENT BY 1 CACHE 10;
...
CREATE SEQUENCE seq_staff_id START WITH 10 INCREMENT BY 1 NOCACHE;
CREATE TABLE staff (
  staff_id NUMBER,
...
CREATE SEQUENCE seq_job_id START WITH 10 INCREMENT BY 1 NOCACHE;
...
CREATE SEQUENCE seq_payroll_id START WITH 1 INCREMENT BY 1 CACHE 500;
...
CREATE SEQUENCE seq_location_id START WITH 10 INCREMENT BY 1 NOCACHE;
...
DROP SEQUENCE seq_office_id;
CREATE SEQUENCE seq_office_id START WITH 10 INCREMENT BY 1 NOCACHE;
...
CREATE SEQUENCE seq_bill_id START WITH 1 INCREMENT BY 1 CACHE 500;
...
DROP SEQUENCE seq_bill_line_id;
CREATE SEQUENCE seq_bill_line_id START WITH 1 INCREMENT BY 1 CACHE 500;
...
CREATE SEQUENCE seq_station_id START WITH 10 INCREMENT BY 1 NOCACHE;
...
CREATE SEQUENCE seq_assignment_id START WITH 1 INCREMENT BY 1 CACHE 100;
...
CREATE SEQUENCE seq_supplier_id START WITH 10 INCREMENT BY 1 NOCACHE;
...
DROP SEQUENCE seq_sup_contact_id;
CREATE SEQUENCE seq_sup_contact_id START WITH 1 INCREMENT BY 1 NOCACHE;
...
DROP SEQUENCE seq_invoice_number;
CREATE SEQUENCE seq_invoice_number START WITH 1 INCREMENT BY 1 CACHE 100;
...
DROP SEQUENCE seq_payment_record_id;
CREATE SEQUENCE seq_payment_record_id START WITH 1 INCREMENT BY 1 CACHE 100;
...
DROP SEQUENCE seq_sup_inv_line_id;
CREATE SEQUENCE seq_sup_inv_line_id START WITH 1 INCREMENT BY 1 CACHE 100;
...
CREATE SEQUENCE seq_category_id START WITH 10 INCREMENT BY 10 NOCACHE;
...
DROP SEQUENCE seq_m_item_id;
CREATE SEQUENCE seq_m_item_id START WITH 1 INCREMENT BY 1 CACHE 10;
...
DROP SEQUENCE seq_tax_code;
CREATE SEQUENCE seq_tax_code START WITH 1 INCREMENT BY 1 NOCACHE;
...
CREATE SEQUENCE seq_po_id START WITH 1 INCREMENT BY 1 CACHE 100;
...
DROP SEQUENCE seq_po_line_id;
CREATE SEQUENCE seq_po_line_id START WITH 1 INCREMENT BY 1 CACHE 100;
...
CREATE SEQUENCE seq_transaction_id START WITH 1 INCREMENT BY 1 CACHE 500;
...
(seq_tax_code.nextval, 12.5, 'VAT');
INSERT INTO tax_rates VALUES 
(seq_tax_code.nextval, 20, 'VAT + new tax (not real, example of scalability)');
INSERT INTO tax_rates VALUES 
(seq_tax_code.nextval, 5, 'reduced VAT (not real, example of scalability)');
...
(seq_category_id.nextval, 'Alcohol', 'Alcoholic beverages, drinks etc, that need a licence to sell');
INSERT INTO product_category VALUES
(seq_category_id.nextval, 'toiletries', 'soap, bath items etc.');
INSERT INTO product_category VALUES
(seq_category_id.nextval, 'meat', 'meats such as beef, chicken etc.');

INSERT INTO products 
(product_id, category_id, product_name, barcode, tax_code, price_rate, min_stock_level, reorder_level)
VALUES
(seq_product_id.nextval, 10, 'Forres Park Puncheon 750ml', '1234567879111', 1, 199.99, 2000, 1700);

INSERT INTO products 
(product_id, category_id, product_name, barcode, tax_code, price_rate, min_stock_level, reorder_level)
VALUES
(seq_product_id.nextval, 20, 'Dove Soap 3pk', '1234567879222', 1, 9.99, 500, 400);

INSERT INTO products 
(product_id, category_id, product_name, barcode, tax_code, price_rate, min_stock_level, reorder_level)
VALUES
(seq_product_id.nextval, 20, 'Colgate Max Fresh large', '1234567879333', 1, 19.99, 500, 400);

INSERT INTO products 
(product_id, category_id, unit_measure, product_name, price_lookup_code, tax_code, price_rate, min_stock_level, reorder_level)
VALUES
(seq_product_id.nextval, 30, 'kg', 'Imported Beef 50lb boxes', '021234', 1, 25.99, 1500, 1400);
...
(seq_transaction_id.nextval, 1, 'IN', TO_DATE('2015-01-01','yyyy-mm-dd'), 1300, 1300, 150, 150);
INSERT INTO cost_sales_tracker VALUES
(seq_transaction_id.nextval, 2, 'IN', TO_DATE('2015-01-02','yyyy-mm-dd'), 300, 300, 5, 5);
INSERT INTO cost_sales_tracker VALUES
(seq_transaction_id.nextval, 3, 'IN', TO_DATE('2015-01-03','yyyy-mm-dd'), 250, 250, 15, 15);


INSERT INTO suppliers VALUES
(seq_supplier_id.nextval, 'Massy Distribution', 
'Corner Churchill Roosevelt Highway and Macoya Road, Trincity',
'They sell pringles');

INSERT INTO suppliers VALUES
(seq_supplier_id.nextval, 'Angostura', 
'Somewhere up North',
'They sell RUM');

INSERT INTO locations VALUES
(seq_location_id.nextval, 'Carlton Center', 'Branch', 'Carlton Center San Fernando');
INSERT INTO locations VALUES
(seq_location_id.nextval, 'Marabella Branch', 'Branch', 'Main Road Marabella');
INSERT INTO locations VALUES
(seq_location_id.nextval, 'S.F.C.S. Warehouse', 'Warehouse', 'St. James Street San Fernando');

INSERT INTO job_posts VALUES
(seq_job_id.nextval, 'general worker', 11, 'hour', 'week');
INSERT INTO job_posts VALUES
(seq_job_id.nextval, 'team leader', 15, 'hour', 'week');
INSERT INTO job_posts VALUES
(seq_job_id.nextval, 'cold storage', 19, 'hour', 'week');
...
VALUES
(seq_staff_id.nextval, 10, 10, 'Harry', 'Potter', 
...
is_active, is_permanent)
VALUES
(seq_staff_id.nextval, 10, 11, 'Sandy', 'Beach', 
...
is_active, is_permanent)
VALUES
(seq_staff_id.nextval, 11, 12, 'Jason', 'Bourne', 
...
(seq_station_id.nextval, 10, NULL);
INSERT INTO cashier_stations VALUES 
(seq_station_id.nextval, 10, NULL);
INSERT INTO cashier_stations VALUES 
(seq_station_id.nextval, 10, NULL);
...
(seq_assignment_id.nextval, 11, 10, 
...
(seq_bill_line_id.nextval, 1, 1, 2, 199.99, 1, 10);
INSERT INTO billed_items VALUES
(seq_bill_line_id.nextval, 1, 2, 10, 9.99, 1, 10);
...
INSERT INTO billed_items VALUES
(seq_bill_line_id.nextval, 2, 1, 2, 199.99, 1, 12.5);
INSERT INTO billed_items VALUES
(seq_bill_line_id.nextval, 2, 2, 10, 9.99, 1, 12.5);
INSERT INTO billed_items VALUES
(seq_bill_line_id.nextval, 2, 3, 10, 19.99, 3, 5);
...
(seq_office_id.nextval, '123-4578', 101, 10, 'Front Desk', 10);
INSERT INTO office_sections VALUES 
(seq_office_id.nextval, '123-4578', 102, 10, 'Accounting', 11);
INSERT INTO office_sections VALUES 
(seq_office_id.nextval, '123-4578', 103, 10, 'Purchasing', 11);
INSERT INTO office_sections VALUES 
(seq_office_id.nextval, '888-4578', 101, 11, 'Front Desk', 12);
INSERT INTO office_sections VALUES 
(seq_office_id.nextval, '888-4578', 102, 11, 'Accounting', 11);
INSERT INTO office_sections VALUES 
(seq_office_id.nextval, '888-5678', NULL, 11, 'Warehouse', 10);

INSERT INTO supplier_contacts VALUES 
(seq_sup_contact_id.nextval, 10, '555-4545', NULL, NULL,
'Don', 'Prince', NULL, NULL);
INSERT INTO supplier_contacts VALUES 
(seq_sup_contact_id.nextval, 10, '555-4578', NULL, NULL,
'Crow', 'Nest', NULL, NULL);
INSERT INTO supplier_contacts VALUES 
(seq_sup_contact_id.nextval, 11, '555-2314', NULL, NULL,
'Lutchman', 'Rumsingh', NULL, NULL);

INSERT INTO payroll VALUES
(seq_payroll_id.nextval, 10,
...
(seq_po_id.nextval, 11, 10, 10, 'T', 'T', 
...
INSERT INTO purchase_orders VALUES
(seq_po_id.nextval, 11, 10, 10, 'T', 'F', 
TO_DATE('2015-01-03','yyyy-mm-dd'), NULL);

INSERT INTO purchase_orders VALUES
(seq_po_id.nextval, 11, 10, 10, 'F', 'T', 
TO_DATE('2015-01-04','yyyy-mm-dd'), TO_DATE('2015-01-05','yyyy-mm-dd'));

INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 1, 1, 300, 177);
INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 1, 2, 50, 7);
INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 1, 3, 75, 12);

INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 2, 1, 300, 177);
INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 2, 2, 50, 7);
INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 2, 3, 75, 12);

INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 3, 1, 300, 177);
INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 3, 2, 50, 7);
INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 3, 3, 75, 12);

INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 4, 1, 300, 177);
INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 4, 2, 50, 7);
INSERT INTO purchase_order_lines VALUES
(seq_po_line_id.nextval, 4, 3, 75, 12);


DROP TABLE sold_products CASCADE CONSTRAINTS;
DROP SEQUENCE seq_sold_products;
CREATE SEQUENCE seq_sold_products START WITH 1 INCREMENT BY 1 CACHE 500;
